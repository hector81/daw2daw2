 ...
 * @author Vespertino
 */
public class ServletConsultaSelectPersonalizada extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String pas = request.getParameter("password");
                String consulta = request.getParameter("consultaPersonalizada");
		...
		out.println("</table><p>");
                ...
                try{
                    ...
                    while(rs.next()){
                        ...
                        out.println("<p>Factura: " + id + "</p>");
                        out.println("<p>Nombre: "+nombre+" ,marca: "+marca+" ,importe: "+importe + "</p>");
                    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletConsultaSelectPersonalizada</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletConsultaSelectPersonalizada at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
